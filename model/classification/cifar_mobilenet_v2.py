...
__all__ = ["cifar_mobilenet_v2"]

model_urls = {
    "cifar_mobilenet_v2": None,
}
...
class MobileNetV2(nn.Module):
    def __init__(
        ...
        if inverted_residual_setting is None:
            ...
            inverted_residual_setting = [
                # t, c, n, s
                [6, width, num_blocks[0], 1],
                [6, width*2, num_blocks[1], 2],
                [6, width*4, num_blocks[2]-1, 2],
                [6, width*8, 1, 1],
            ]
            ...
            inverted_residual_setting = [
                ...
                [6, width, num_blocks[0], 1],
                [6, width*2, num_blocks[1], 2],
                [6, width*4, num_blocks[2], 2],
                [6, width*8, num_blocks[3]-1, 2],
                [6, width*16, 1, 1],
            ]
...
def cifar_mobilenet_v2(**kwargs: Any) -> MobileNetV2:
    """
